...
.message-text {
  @apply m-0 text-[15px] leading-[1.72] whitespace-pre-wrap break-words text-slate-800;
  overflow-wrap: anywhere;
}
...
.message-blockquote {
  @apply m-0 border-l-4 border-sky-300 pl-4 pr-3 py-2 text-[15px] leading-[1.7] whitespace-pre-wrap break-words text-slate-700 bg-sky-50/70 rounded-r-xl;
  overflow-wrap: anywhere;
}

.message-list {
  @apply m-0 pl-5 text-[15px] leading-[1.68] text-slate-800 flex flex-col gap-2;
}
...
.message-inline-code {
  @apply rounded-md border border-slate-200 bg-slate-100 px-1.5 py-0.5 font-mono text-[0.9em] font-medium text-slate-900;
  line-height: 1.45;
}

.message-code-block {
  @apply overflow-hidden rounded-2xl border border-slate-700/70 bg-slate-950 text-slate-100 shadow-lg shadow-slate-950/10;
}
...
.message-code-pre {
  @apply m-0 overflow-x-auto px-4 py-4 text-[13px] leading-[1.65] font-mono whitespace-pre;
  -webkit-overflow-scrolling: touch;
}
...
@media (max-width: 640px) {
  ...
  .message-heading-h1 { @apply text-xl; }
  .message-heading-h2 { @apply text-lg; }
  .message-heading-h3 { @apply text-base; }
